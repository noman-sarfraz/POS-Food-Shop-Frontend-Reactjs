...
const navItems = [
  ...
  { text: "Products", icon: <FastfoodIcon />, link: "/admin/products" },
  { text: "Orders", icon: <RedeemIcon />, link: "/admin/orders" },
  { text: "Admins", icon: <ManageAccountsIcon />, link: "/admin/admins" },
  { text: "Users", icon: <GroupIcon />, link: "/admin/users" },
  // { text: "Messages", icon: <MessageIcon />, link: "/admin/messages" },
];
